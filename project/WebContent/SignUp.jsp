      ...
      <div class="panel-body">
      	<form action = "SignUp" method = "post">
  			...
  			<div class="form-group">
    			...
    			<input type="password" class="form-control" id="pass" aria-describedby="emailHelp" placeholder="Enter password" name="pass" required>
  			</div>
  			<div class="form-group">
  			...
  			<div class="form-group">
    			...
    			<input type="text" class="form-control" id="cpass" aria-describedby="emailHelp" placeholder="Enter security question" name="secques" required>
  			</div>
  			<div class="form-group">
    			<label for="sans">Security Answer:</label>
    			<input type="text" class="form-control" id="cpass" aria-describedby="emailHelp" placeholder="Enter security answer" name="secans" required>
  			</div>
  			<div class="form-group">
    			<label for="cpass">User Name:</label>
    			<input type="text" class="form-control" id="uname" aria-describedby="emailHelp" placeholder="Enter username" name="uname" required>
  			</div>
  			<div class="form-group">
