...
<div class="container">
  <h2 style="color:#07C2B4">Facility Head</h2>  
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="./IMAGES/facilityHead.jpg" alt="Cargo Facility" style="width:100%;">
      </div>

      <div class="item">
        <img src="./IMAGES/facilityHead1.jpg" alt="Facility Management" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="./IMAGES/facilityHead2.jpg" alt="Hostel Facility" style="width:100%;">
      </div>
    </div>
